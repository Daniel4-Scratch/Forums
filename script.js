...
function endBox(){
  ...
  setTimeout(function(){ document.body.innerHTML += '<br><div class="box"> <center>Footer </center> </div> <div class="box-content">Search is broken<br><input><button>Search</button><br>or<br>Browse for a post <a href="https://github.com/Daniel4-Scratch/Forums/tree/main/topics">here</a>.</div>' }, 1000);
